...
export default function App() {
  ...
  const generatePDF = async () => {
    if (window && typeof window.html2pdf === "function" && pdfRef.current && !autoGenerated) {
      await waitForFonts(); // ✅ ensure fonts loaded
      ...
      const opt = {
        ...
        jsPDF: { unit: "mm", format: [80, Math.max(mmHeight + 10, 120)], orientation: "portrait" },
      };
...
const waitForFonts = async () => {
  ...
  const styles = {
    ...
    telugu: { fontFamily: "'Noto Sans Telugu', Lexend, sans-serif", fontSize: "10px" },
  };
